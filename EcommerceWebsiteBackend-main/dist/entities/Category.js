...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ProductType_1.ProductType, (productType) => productType.categories, { nullable: false, onDelete: "RESTRICT" }),
    (0, typeorm_1.JoinColumn)({ name: "type_id" }),
    __metadata("design:type", ProductType_1.ProductType)
], Category.prototype, "productType", void 0);
__decorate([
